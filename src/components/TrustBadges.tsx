        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-sm font-bold text-gray-800 group-hover:text-blue-600 transition-colors">CQC Registered</p>
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl mb-3 w-full h-32 flex items-center justify-center transition-all hover:-translate-y-1 card-enhanced">
                <div className="text-purple-600 transform group-hover:scale-110 transition-transform">
                  <svg className="w-16 h-16 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
              </div>
              <p className="text-sm font-bold text-gray-800 group-hover:text-purple-600 transition-colors">24/7 Available</p>
