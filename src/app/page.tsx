...
export default function Home() {
  return (
    <div className="space-y-16">
      ...
      <section className="relative h-[680px] w-full overflow-hidden bg-gradient-to-br from-background via-white to-secondary/40">
        <div className="absolute inset-0 w-full h-full">
          ...
          <div className="gradient-blob top-10 -left-10 w-72 h-72 rounded-full bg-gradient-to-br from-primary/40 to-accent/40 animate-float-slow" />
          <div className="gradient-blob -bottom-16 -right-10 w-80 h-80 rounded-full bg-gradient-to-br from-accent/40 to-secondary/50 animate-float-slow" />
        </div>
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center">
          <div className="max-w-3xl text-white bg-white/20 p-6 rounded-lg">
            ...
            <div className="space-x-4 animate-fade-up anim-delay-600">
              <Link
                href="/services"
                className="inline-block bg-gradient-to-r from-primary to-accent text-white px-8 py-3 rounded-lg transition-all hover:scale-105 shadow-lg"
              >
                Our Services
              </Link>
              <Link
                href="/contact"
                className="inline-block bg-white text-primary px-8 py-3 rounded-lg hover:bg-gray-100 transition-all hover:scale-105 shadow-lg"
              >
                Get in Touch
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {careTypes.map((care, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 group-hover:text-accent transition-colors">{care.title}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            <div className="bg-white/90 backdrop-blur p-8 rounded-xl shadow-md">
              <div className="inline-block mb-4 px-3 py-1 bg-secondary/20 rounded-full">
                <span className="text-sm font-semibold text-primary">🏆 CQC Regulated</span>
              </div>
              ...
              <Link href="/services" className="inline-flex items-center text-primary font-medium hover:text-accent">
              ...
              <div className="flex items-center mb-6">
                <div className="relative w-16 h-16 mr-4">
                  <CustomImage
                    ...
                    className="rounded-full overflow-hidden border-4 border-secondary/40"
                  />
      ...
      <section className="relative h-[400px] w-full overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          <CustomImage
            ...
            className="w-full h-full"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-primary/90 via-primary/70 to-primary/90 pointer-events-none" />
        </div>
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center justify-center">
          <div className="text-center text-white hero-text-enhanced max-w-3xl">
            ...
            <div className="space-x-4">
              <Link
                href="/contact"
                className="inline-block bg-white text-primary px-8 py-3 rounded-lg hover:bg-gray-100 transition-all hover:scale-105 shadow-xl"
              >
                Contact Us
              </Link>
              <Link
